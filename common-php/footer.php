        ...
        <div class="footer__services">
          <div class="footer__service-row">
            ...
            <div class="service">
              ...
              <ul class="service__list js-resource-list">
                ...
                <li><a href="./resource.html#etc" data-i18n="">추가 리소스</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="footer__service-row">
            <div class="service">
              ...
              <ul class="service__list">
                <li><a href="https://jira.osci.kr/servicedesk/customer/portal/21" target="_blank" data-i18n="buy.prd">제품 문의</a></li>
                <li><a href="https://jira.osci.kr/servicedesk/customer/portal/21" target="_blank" data-i18n="support.tech">기술 지원</a></li>
            ...
            <div class="service service--contact">
              ...
              <ul class="service__list">
                <li>
                  <a href="mailto:sales@osci.kr">제품 문의 - sales@osci.kr</a>
                </li>
                <li>
                  <a href="mailto:lab@osci.kr">기술 문의 - lab@osci.kr</a>
                </li>
              </ul>
            </div>
